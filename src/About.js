    ...
    return (
      <div className="contentDiv" style={{paddingTop:"25px"}}>
        ...
        <p id="textBody">
          ...
          an absolutely incredible time of fellowship, prayer, praise, intimacy and growth. There will be messages from the Word, praise music,
          intimate small groups, fun group games and activities, and of course amazing fine dining. It is also a great time to make friends as well, so if you
          completely don't know anyone who is going, you are sure to come back with exponentially more friends than when you first arrived.
          <br></br><br></br>
          "Winter Retreat is the greatest thing I have ever experienced" - every person who ever attended, 2017
        </p>
        ...
        <p id="textBody">
          ...
          on December 28th sometime like around 12 or so? Something like that
        </p>
        ...
        <p id="textBody">
          <ul id="listStyle">
            ...
            <li>Snacks (ie: Shin Ramen, carrots & celery, discounted halloween candy, and that super spicy Korean ramen that comes in that black packaging)</li>
          </ul>
        </p>
        ...
        <p id="textBody">
          <ul id="listStyle">
            ...
            <li>Weapons (ie: firearms, knives, excaliburs, Trident of Poseidon, The Elder Wand, a nuclear missile)</li>
            <li>A swimsuit (even though there is a lake, it will be winter time)</li>
            <li>Negativity</li>
            <li>Stolen goods</li>
          </ul>
        </p>
